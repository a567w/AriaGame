 ...
 */
/************************************************************************************************/
typedef struct _KS_GEOMETRY_HEADER
{
	KsUInt16		id;
	KsUInt16		type;
	KsUInt16		flags;
 ...
 */
/************************************************************************************************/
KsGeometry::KsGeometry( KsUInt16 numVertices, KsUInt16 numFaces, KsUInt16 numMaterials, KsUInt16 numTextures )
{
	m_id[ 0 ]      = 'T';
	m_id[ 1 ]      = 'K';
	m_id[ 2 ]      = 'M';
