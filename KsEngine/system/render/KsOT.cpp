...
KsTask*	KsOT_List::m_sortTbl[ ksOT_SORT_TBL_MAX ];	/**< タスクが4096超えることは、あるかな・・・？(16kbyte) */
 ...
 */
/************************************************************************************************/
void KsTaskQuickSort( KsTask** pSortTbl, KsInt32 left, KsInt32 right )
{
	KsTask*			pTemp;
	KsInt32			i, j;
	KsInt32			val;
 ...
 */
/************************************************************************************************/
void KsTaskZSort( KsTask** pSortTbl, KsInt32 left, KsInt32 right )
{
	KsTask*			pTemp;
	KsInt32			i, j;
	KsReal			val;
 ...
 */
/************************************************************************************************/
void KsOT_List::add( KsTask* pTask )
{
#if 0
 ...
 */
/************************************************************************************************/
void KsOT_List::remove( KsTask* pTask )
{
 ...
 */
/************************************************************************************************/
KsBool KsOT::entry( KsTask* pTask )
{
 ...
 */
/************************************************************************************************/
void KsOT::remove( KsTask* pTask )
{
	KsAssert( pTask != NULL, "登録タスクがNULLです!!" );
	//ksAssert( pTask->getOrder() < m_orderMax, "登録タスクのオーダーが範囲外です!!" );
...
#if 0
	/* 描画処理 */
	//for( KsUInt32 i=0; i<getOrderMax(); i++ )
	//for( KsUInt32 i=getOrderMax()-1; i>0; i-- )
	for( KsUInt32 i=0; i<getOrderMax(); i++ )
	{
		orderRender( i, pParam );
	}
#endif
}
