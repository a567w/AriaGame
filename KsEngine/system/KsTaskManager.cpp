 ...
 */
/************************************************************************************************/
void* KsTaskManager::setManagerCallback( KsTaskBase* pTask, void* pParam )
{
	if( pTask )
	{
 ...
 */
/************************************************************************************************/
KsTaskBase* KsTaskManager::getRootTask()
{
	return m_pRootTask;
}
 ...
 */
/************************************************************************************************/
KsTaskBase* KsTaskManager::setRootTask( KsTaskBase* pTask )
{
	KsTaskBase*			pOldTask;
 ...
 */
/************************************************************************************************/
void KsTaskManager::taskExecute( KsTaskBase* pTask, void* pUserData )
{
	if( pTask )
	{
		/* 初期化フラグをチェックする */
 ...
 */
/************************************************************************************************/
void KsTaskManager::kill( KsTaskBase* pTask, void* pParam )
{
 ...
 */
/************************************************************************************************/
void KsTaskManager::allChildCallback( KsTaskBase* pTask, KsTaskCallback callback, void* pUserData )
{
	if( pTask )
	{
