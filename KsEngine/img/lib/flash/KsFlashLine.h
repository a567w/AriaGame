...
/* $Id: KsFlashLine.h,v 1.1.1.1 2005/10/05 17:33:26 TSUKASA Exp $ */
...
{
	public:
	KsFlashLine( KsUInt16 width, const KsFlashColor& color );
	KsFlashLine( KsUInt16 width, KsUInt8 r, KsUInt8 g, KsUInt8 b );
	KsFlashLine( KsUInt16 width, KsUInt8 r, KsUInt8 g, KsUInt8 b, KsUInt8 a );
	
		KsUInt16			m_width;
		KsFlashColor		m_color;
};
