 ...
 */
/************************************************************************************************/
KsDeferredLighting::KsDeferredLighting( KsRenderSystem* pRenderSystem, KsUInt32 width, KsUInt32 height, KsUInt32 MSAA )
 ...
 */
/************************************************************************************************/
KsDeferredLighting::~KsDeferredLighting()
{
 ...
 */
/************************************************************************************************/
void KsDeferredLighting::initializeLight()
{
 ...
 */
/************************************************************************************************/
void KsDeferredLighting::updateLight( KsReal elapsedTime, KsCamera* pCamera, KsModelParameter* pModelParameter )
{
 ...
 */
/************************************************************************************************/
void KsDeferredLighting::computeLighting( KsUInt32 numTexture, KsTexture** pTextures )
{
