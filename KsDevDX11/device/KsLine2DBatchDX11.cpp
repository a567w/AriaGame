...
namespace
{
	KS_INPUT_ELEMENT_DESC VS_LINE2D_LAYOUT[] =
	{
 ...
 */
/************************************************************************************************/
KsLine2DBatchDX11::KsLine2DBatchDX11( KsUInt32 count )
	: m_lineCount( 0 )
	, m_lineMax( 0 )
	, m_lineIndex( 0 )
	, m_lineStride( 0 )
 ...
 */
/************************************************************************************************/
KsLine2DBatchDX11::~KsLine2DBatchDX11()
{
	destroy();
}
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::create( KsUInt32 count )
{
	...
	m_pLineVS = (KsVertexShader*)pShaderManager->createFromFile( "line.fx", "VS_Line2D", ksSHADE_MODEL_5_0, ksVERTEX_SHADER );
	m_pLinePS = (KsPixelShader*) pShaderManager->createFromFile( "line.fx", "PS_Line2D", ksSHADE_MODEL_5_0, ksPIXEL_SHADER  );
	m_pLineVB = pHardwareBufferManager->createVertexBuffer( sizeof(KS_VERTEX_LINE3D), count * 2, ksLINE3D_FVF, ksCPU_ACCESS_WRITE );
	m_pLineIL = pInputLayoutManager->createInputLayout( VS_LINE2D_LAYOUT, ksARRAYSIZE( VS_LINE2D_LAYOUT ), (KsVertexShader*)m_pLineVS );
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::destroy()
{
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::setColor( const KsColorReal& rectColor )
{
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::setColor( KsReal r, KsReal g, KsReal b, KsReal a )
{
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::draw( const KsVector3d& start, const KsVector3d& end )
{
 ...
 */
/************************************************************************************************/
void KsLine2DBatchDX11::flush( KsRenderContext* pRenderContext )
{
	if( m_lineCount )
	{
