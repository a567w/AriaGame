 ...
 */
/************************************************************************************************/
#ifndef __KSUNORDEREDACCESSVIEWDX11_H__
#define __KSUNORDEREDACCESSVIEWDX11_H__
 ...
 */
/************************************************************************************************/
class ksDEVDX11_API KsUnorderedAccessViewDX11 : public KsUnorderedAccessView
{
	...
	public:
		 ...
		 * @param	flags			フラグ
		 */
									KsUnorderedAccessViewDX11( KsRenderSystemDX11* pRenderSystem, KsUInt32 elementSize, KsUInt32 numElements, KsUInt32 format, KsUInt32 flags );

		/**
		 * デストラクタ
		 */
		virtual						~KsUnorderedAccessViewDX11();
...
#endif		/* __KSUNORDEREDACCESSVIEWDX11_H__ */
