/************************************************************************************************/
/** 
 * @file		KsUnorderedAccessViewDX11.h
 * @brief		UAVバッファ
 * @author		Tsukasa Kato
 * @date		----/--/--
 * @since		----/--/--
 ...
 */
/************************************************************************************************/
KsUnorderedAccessViewDX11::KsUnorderedAccessViewDX11( KsRenderSystemDX11* pRenderSystem, KsUInt32 elementSize, KsUInt32 numElements, KsUInt32 format, KsUInt32 flags )
	: m_elementSize( 0 )
	, m_numElements( 0 )
	, m_format( 0 )
	, m_pBuffer( 0 )
 ...
 */
/************************************************************************************************/
KsUnorderedAccessViewDX11::~KsUnorderedAccessViewDX11()
{
 ...
 */
/************************************************************************************************/
KsBool KsUnorderedAccessViewDX11::create( KsRenderSystemDX11* pRenderSystem, KsUInt32 elementSize, KsUInt32 numElements, KsUInt32 format, KsUInt32 flags )
{
 ...
 */
/************************************************************************************************/
void KsUnorderedAccessViewDX11::destroy()
{
	delete this;
}
 ...
 */
/************************************************************************************************/
void KsUnorderedAccessViewDX11::active()
{
}
 ...
 */
/************************************************************************************************/
void* KsUnorderedAccessViewDX11::getBufferResource()
{
	return m_pBuffer;
}
 ...
 */
/************************************************************************************************/
void* KsUnorderedAccessViewDX11::lock( const KsRenderContext* pContext, KsUInt32 flags )
{
#if 0
	void*		pBuffer;
 ...
 */
/************************************************************************************************/
void KsUnorderedAccessViewDX11::unlock( const KsRenderContext* pContext )
{
 ...
 */
/************************************************************************************************/
void KsUnorderedAccessViewDX11::read( const KsRenderContext* pContext, void* pData, KsUInt32 size )
{
#if 0
	void*		pBuffer;
 ...
 */
/************************************************************************************************/
void KsUnorderedAccessViewDX11::write( const KsRenderContext* pContext, void* pData, KsUInt32 size )
{
#if 0
